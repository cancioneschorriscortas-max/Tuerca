...
const ESQUELETO = {
  GRUNT: [
    ...
    { id:'brazo_e', centro:[-0.63,0.16,0.06],tam:[0.26,0.72,0.30], cor:'azul',   piv:[-0.63,0.46,0],  eixe:'x' },
    { id:'brazo_d', centro:[ 0.63,0.16,0.06],tam:[0.26,0.72,0.30], cor:'azul',   piv:[ 0.63,0.46,0],  eixe:'x' },
    ...
    { id:'arma',    centro:[0.30,-0.08,0.62],tam:[0.18,0.18,1.25], cor:'escuro', piv:[0.30,-0.08,0.12], eixe:'y', ang:DIAG },
    { id:'arma',    centro:[0.26,-0.10,0.20],tam:[0.30,0.26,0.26], cor:'escuro', piv:[0.30,-0.08,0.12], eixe:'y', ang:DIAG },
  ],
  HEAVY: [
    ...
    { id:'torso',   centro:[ 0.76,0.44,0],   tam:[0.34,0.34,0.70], cor:'azul',   piv:[0,-0.30,0],     eixe:'x' },
    { id:'brazo_e', centro:[-0.80,0.02,0.06],tam:[0.28,0.72,0.32], cor:'azul',   piv:[-0.80,0.34,0],  eixe:'x' },
    { id:'brazo_d', centro:[ 0.80,0.02,0.06],tam:[0.28,0.72,0.32], cor:'azul',   piv:[ 0.80,0.34,0],  eixe:'x' },
    ...
    { id:'arma',    centro:[0.24,-0.18,0.72],tam:[0.28,0.28,1.50], cor:'escuro', piv:[0.24,-0.18,0.14], eixe:'y', ang:DIAG },
    { id:'arma',    centro:[0.20,-0.18,0.16],tam:[0.40,0.40,0.34], cor:'escuro', piv:[0.24,-0.18,0.14], eixe:'y', ang:DIAG },
  ],
  ENGINEER: [
    ...
    { id:'brazo_e', centro:[-0.58,0.16,0.04],tam:[0.24,0.70,0.28], cor:'azul',   piv:[-0.58,0.44,0],  eixe:'x' },
    { id:'brazo_d', centro:[ 0.58,0.16,0.04],tam:[0.24,0.70,0.28], cor:'azul',   piv:[ 0.58,0.44,0],  eixe:'x' },
    ...
    { id:'arma',    centro:[0.28,-0.22,0.46],tam:[0.16,0.18,0.80], cor:'ambar',  piv:[0.28,-0.22,0.10], eixe:'y', ang:DIAG },
  ],
};
...
/* ============================================================
   ...
   ============================================================ */
function montar(cls, estado, fase, corEquipo){
